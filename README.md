...
- [Use Autodetected Plate](NIS_v6.10/18-Use_detected_plate/README.md)
  ...
  - [Modify Well Selection in Sample Navigation](NIS_v6.10/13-Modify_selection_sample_nav/README.md)

  - [Export Well Labeling to Sample Navigation](NIS_v6.10/19-Export_labeling_to_sample_nav/README.md)

  - [Use Well Labeling from Sample Navigation](NIS_v6.10/14-Use_labeling_sample_nav/README.md)

  - [Autosignal on Plate](NIS_v6.10/15-Autosignal_on_plate/README.md)

  - [Continuous Scan of Well Centers](NIS_v6.10/21-Continuous_scan_wells/README.md)

  - [Find Well containing Cells using Continuous Scan](NIS_v6.10/16-Find_well/README.md)

  - [Remove Wells from Selection](NIS_v6.10/22-Remove_wells_from_selection/README.md)

  - [Find Well containing Cells using Continuous Scan and Find Focus Position](NIS_v6.10/28-Detect_wells_focus/README.md)

  - [Time Sequence](NIS_v6.10/27-Time_sequence/README.md)

- [Scan Wellplate from Sample Navigation](NIS_v6.10/16-Scan_wellplate/README.md)

  - [Brightfield Autofocus Scan](NIS_v6.10/16-Scan_wellplate/BFScanREADME.md)

  - [Fluorescence Autofocus Scan](NIS_v6.10/16-Scan_wellplate/FluoScanREADME.md)

- [Detect a Plate and Capture](NIS_v6.10/17-Detect_and_capture/README.md)
